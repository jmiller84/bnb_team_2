...
def test_new_space_constructs_correctly():
    space = Space(1, "Cottage", "Kent", "UK", "A relaxing cottage", 27, 4)
    assert space.id == 1
...
def test_new_space_displays_nicely():
    space = Space(1, "Cottage", "Kent", "UK", "A relaxing cottage", 27, 4)
    assert str(space) == "Space(1, Cottage, Kent, UK, A relaxing cottage, 27, 4)"

"""
Check 2 spaces with same attributes are equal
"""
def test_spaces_are_equal():
    space1 = Space(1, "Cottage", "Kent", "UK", "A relaxing cottage", 27, 4)
    space2 = Space(1, "Cottage", "Kent", "UK", "A relaxing cottage", 27, 4)
