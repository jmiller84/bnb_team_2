...
class SpaceRepository:
    ...
    def create(self, space):
        self._connection.execute("INSERT INTO spaces (name, description, price) VALUES (%s, %s, %s, %s, %s) RETURNING id", [space.name, space.description, space.price, space.owner_id])
